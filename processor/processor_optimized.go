...
// ProcessRowsOptimized - High-performance version using worker pool pattern
func ProcessRowsOptimized(ctx context.Context, firebirdDB, mysqlDB *sql.DB, numWorkers int, cfg config.Config) (inserted, updated, ignored int, batchSize int, stats *ProcessingStats, err error) {
...
// calculatePrices calculates prices based on cost
